...
int main(int argc, char* argv[])
{
    ...
    window = SDL_CreateWindow("SetThree", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, windowWidth, windowHeight, SDL_WINDOW_RESIZABLE);
    ...
    bool running = true;
    SDL_Texture* introT = IMG_LoadTexture(renderer, "res/intro.png");
    SDL_FRect introR;
    introR.w = 128;
    introR.h = windowHeight / 2-40;
    introR.x = windowWidth / 2 - introR.w / 2;
    introR.y = 20;
    Text middleText;
    middleText.dstR.w = 140;
    middleText.dstR.h = 20;
    middleText.dstR.x = windowWidth / 2 - middleText.dstR.w / 2;
    middleText.dstR.y = windowHeight - 120;
    middleText.setText(renderer, robotoF, "Team and project managment with", { 0, 0, 0 });
    Text middle2Text;
    middle2Text.dstR.w = 140;
    middle2Text.dstR.h = 20;
    middle2Text.dstR.x = windowWidth / 2 - middle2Text.dstR.w / 2;
    middle2Text.dstR.y = middleText.dstR.y + middleText.dstR.h;
    middle2Text.setText(renderer, robotoF, "solution providing App", { 0, 0, 0 });
    Text bottomText;
    bottomText.dstR.w = 120;
    bottomText.dstR.h = 30;
    bottomText.dstR.x = windowWidth / 2 -100;
    bottomText.dstR.y = windowHeight - 50;
    bottomText.setText(renderer, robotoF, "Get Started", { 0, 0, 0 });
    Text upperText;
    upperText.dstR.w = 120;
    upperText.dstR.h = 30;
    upperText.dstR.x = middleText.dstR.x;
    upperText.dstR.y = introR.y + introR.h + 25;
    upperText.setText(renderer, robotoF, "Manage your daily tasks", { 0, 0, 0 });
    while (running) {
        SDL_Event event;
        ...
        upperText.draw(renderer);
        middleText.draw(renderer);
        middle2Text.draw(renderer);
        bottomText.draw(renderer);
        SDL_RenderCopyF(renderer, introT, 0, &introR);
